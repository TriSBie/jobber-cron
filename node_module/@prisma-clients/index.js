...
const config = {
  ...
  "inlineSchemaHash": "636697048cd20edc117f9b017b4cff863ca6094fc4a018b071e0dc39172290a9",
  "copyEngine": true
}
...
path.join(process.cwd(), "../../node_module/@prisma-clients/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../../node_module/@prisma-clients/schema.prisma")
