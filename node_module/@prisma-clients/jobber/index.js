...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\jobs\\jobber-remake\\jobber\\node_module\\@prisma-clients\\jobber",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\jobs\\jobber-remake\\jobber\\apps\\jobber\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
  },
  "relativePath": "../../../apps/jobber/prisma",
  "clientVersion": "6.8.2",
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../../../node_module/@prisma-clients/jobber\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"AUTH_DATABASE_URL\")\n}\n\nmodel User {\n  id       Int    @id @default(autoincrement())\n  email    String @unique\n  password String\n}\n",
  "inlineSchemaHash": "ad2b910262f39baa5e56f25c2f802a9bfde4d0daa5830dd0547c5dd6b4297a55",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "../../node_module/@prisma-clients/jobber",
    "../node_module/@prisma-clients/jobber",
  ]
...
path.join(process.cwd(), "../../node_module/@prisma-clients/jobber/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../../node_module/@prisma-clients/jobber/schema.prisma")
